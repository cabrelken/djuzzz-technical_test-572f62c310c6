      ...
      >
        ...
        <div class="menu-item">
          ...
          >
            ...
            <span class="menu-title">Boostrap 5 (inline style)</span>
          </a>
          <!--end:Menu link-->
        </div>
        <div class="menu-item">
          ...
          >
            ...
            <span class="menu-title">Element plus</span>
          </a>
          <!--end:Menu link-->
        </div>
        <!--end:Menu item-->
        <div class="menu-item">
          ...
          >
            ...
            <span class="menu-title">Documentation metronic</span>
          </a>
          <!--end:Menu link-->
        </div>
        <!--begin:Menu item-->
        ...
        <div class="menu-item">
          ...
          >
            ...
            <span class="menu-title">Vuejs</span>
          </a>
          <!--end:Menu link-->
        </div>
        <!--begin:Menu item-->
