...
/**
 * Set the toolbar display on desktop
 * @returns {boolean}
 */
 export const toolbarPositionDesktop = computed(() => {
  return store.getters.layoutConfig("toolbar.fixed.desktop");
});
 ...
 * @returns {boolean}
 */
 export const toolbarPositionMobile = computed(() => {
  return store.getters.layoutConfig("toolbar.fixed.mobile");
});
